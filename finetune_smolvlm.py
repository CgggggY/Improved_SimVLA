...
# ============================================================
def get_args_parser():
    parser = argparse.ArgumentParser("SmolVLM-VLA Finetune (paraphrase augmentation)", add_help=False)
...
def main(args):
    ...
    for batch in train_dataloader:
        ...
        if paraphrase_map is not None and "language_instruction" in batch:
            orig_langs = batch["language_instruction"]
            new_langs = [
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("SmolVLM-VLA finetune (paraphrase aug)", parents=[get_args_parser()])
